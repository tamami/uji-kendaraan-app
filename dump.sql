...
INSERT INTO `data_adm_kendaraan` VALUES (1,'H. AGUS','BBK SENTRAL','MITSUBISHI','T120SSBC','2015',2,1,4,'D1961BK','BD190330','MHMV5WY2EFK-003736','4G15L-49722',3,'2017-06-03');
...
--
-- Table structure for table `ref_biaya_pemeriksaan`
--

DROP TABLE IF EXISTS `ref_biaya_pemeriksaan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ref_biaya_pemeriksaan` (
  `id` int(11) NOT NULL,
  `id_jns_kendaraan` int(11) DEFAULT NULL,
  `tarif` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_jns_kendaraan` (`id_jns_kendaraan`),
  CONSTRAINT `ref_biaya_pemeriksaan_ibfk_1` FOREIGN KEY (`id_jns_kendaraan`) REFERENCES `ref_jns_kendaraan` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ref_biaya_pemeriksaan`
--

LOCK TABLES `ref_biaya_pemeriksaan` WRITE;
/*!40000 ALTER TABLE `ref_biaya_pemeriksaan` DISABLE KEYS */;
INSERT INTO `ref_biaya_pemeriksaan` VALUES (1,1,10000),(2,2,20000),(3,3,20000);
/*!40000 ALTER TABLE `ref_biaya_pemeriksaan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ref_jns_kendaraan` VALUES (1,'MOBIL PENUMPANG'),(2,'MOBIL BIS'),(3,'MOBIL BARANG');
...
INSERT INTO `skrd` VALUES (1,'BD190330','BERKALA',20000,0,10000,15000,0,'2017-06-03','2017-06-10','2017-12-03');
...
-- Dump completed on 2017-06-03 23:35:50
